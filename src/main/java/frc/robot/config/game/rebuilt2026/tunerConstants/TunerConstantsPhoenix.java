...
// Renamed from TunerConstants to TunerConstantsPhoenix
public class TunerConstantsPhoenix {
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.443603515625);
  ...
  // This is also in GeneratedTunerSwerveDrivetrain in the drive subsystem
